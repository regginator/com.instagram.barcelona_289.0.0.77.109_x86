...
import ch.boye.httpclientandroidlib.impl.p004io.HttpRequestParser;
import ch.boye.httpclientandroidlib.impl.p004io.HttpResponseWriter;
...
public abstract class AbstractHttpServerConnection implements HttpServerConnection {
    ...
    public HttpMessageParser requestParser = null;
    public HttpMessageWriter responseWriter = null;
    ...
    public void init(SessionInputBuffer sessionInputBuffer, SessionOutputBuffer sessionOutputBuffer, HttpParams httpParams) {
        if (sessionInputBuffer != null) {
            if (sessionOutputBuffer != null) {
                ...
                this.requestParser = new HttpRequestParser(sessionInputBuffer, null, new DefaultHttpRequestFactory(), httpParams);
                this.responseWriter = new HttpResponseWriter(sessionOutputBuffer, null, httpParams);
