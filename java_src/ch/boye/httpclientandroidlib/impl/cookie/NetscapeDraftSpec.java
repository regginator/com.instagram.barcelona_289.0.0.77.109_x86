...
public class NetscapeDraftSpec extends CookieSpecBase {
        ...
        if (header != null) {
            if (cookieOrigin != null) {
                if (header.getName().equalsIgnoreCase(InterfaceC0026SM.SET_COOKIE)) {
                    ...
                    return parse(new HeaderElement[]{netscapeDraftHeaderParser.parseHeader(A0O, A0G)}, cookieOrigin);
                }
    ...
    public NetscapeDraftSpec(String[] strArr) {
        ...
        if (strArr != null) {
            ...
            strArr2 = new String[]{EXPIRES_PATTERN};
        }
        this.datepatterns = strArr2;
        registerAttribHandler(ClientCookie.PATH_ATTR, new BasicPathHandler());
        C34901Hvb.A14(new NetscapeDomainHandler(), this);
