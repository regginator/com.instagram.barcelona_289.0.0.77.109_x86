...
public final class FilterChain implements FilterModel {
    public static final Parcelable.Creator CREATOR = C91564uW.A0Z(14);
    public boolean A00;
    ...
    public final FilterChain AHP() {
        ...
        String str = this.A04;
        boolean z = this.A00;
        return new FilterChain(sparseArray2, sparseArray4, new TransformMatrixParams(this.A03), str, C22185Bs3.A1Y(this.A06), C22185Bs3.A1Y(this.A05), z);
    }
    ...
    public FilterChain() {
        this(C91554uV.A0P(), C91554uV.A0P(), C22185Bs3.A0G(false), "filter_chain", DQ1.A00(), DQ1.A00(), true);
    }
}
