...
public final class FlareTransitionFilter implements TransitionFilter {
    public static final Parcelable.Creator CREATOR = C91564uW.A0Z(33);
    public float A00;
    public boolean A01;
    ...
    public final /* bridge */ /* synthetic */ FilterModel AHP() {
        FlareTransitionFilter flareTransitionFilter = new FlareTransitionFilter(new TransformMatrixParams(this.A02), C22185Bs3.A1Y(this.A04), C22185Bs3.A1Y(this.A03), BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER, true);
