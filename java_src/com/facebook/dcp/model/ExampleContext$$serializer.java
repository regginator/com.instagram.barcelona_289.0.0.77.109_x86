...
public final class ExampleContext$$serializer implements InterfaceC34898HvY {
    ...
    */
    public void serialize(Encoder encoder, ExampleContext exampleContext) {
        boolean A1Z = C25920wp.A1Z(encoder, exampleContext);
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = descriptor;
        ...
        if (z || !C0OR.A0I(exampleContext.A01, "")) {
            AAG.AK3(exampleContext.A01, pluginGeneratedSerialDescriptor, 0);
        }
    }
    ...
    static {
        ...
        descriptor = C34902Hvc.A0y("com.facebook.dcp.model.ExampleContext", exampleContext$$serializer);
    }
