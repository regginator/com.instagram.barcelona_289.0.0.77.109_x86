...
public final class MetadataResponse$$serializer implements InterfaceC34898HvY {
    ...
    public MetadataResponse deserialize(Decoder decoder) {
        ...
        while (true) {
            ...
            if (AH0 != -1) {
                if (AH0 == 0) {
                    obj = AAF.AHF(obj, SignalsMetadata$$serializer.INSTANCE, pluginGeneratedSerialDescriptor, 0);
                    i |= 1;
                } else {
    ...
    public InterfaceC34899HvZ[] childSerializers() {
        return new InterfaceC34899HvZ[]{SignalsMetadata$$serializer.INSTANCE};
    }
    ...
    public void serialize(Encoder encoder, MetadataResponse metadataResponse) {
        ...
        if (((C38968KYi) A0v).A03.A05 || !C0OR.A0I(metadataResponse.A00, new SignalsMetadata((String) null, 3))) {
            A0v.AJz(metadataResponse.A00, SignalsMetadata$$serializer.INSTANCE, pluginGeneratedSerialDescriptor, A1Y ? 1 : 0);
        }
