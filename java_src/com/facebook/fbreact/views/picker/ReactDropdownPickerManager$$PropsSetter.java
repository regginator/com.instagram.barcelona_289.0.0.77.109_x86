    ...
    public final /* bridge */ /* synthetic */ void Cp7(View view, ViewManager viewManager, Object obj, String str) {
        ...
        switch (str.hashCode()) {
            ...
            case -1721943862:
                ...
                switch (c) {
                    case 4:
                        reactDropdownPickerManager.setTranslateX(i0v, C34901Hvb.A02(obj, obj, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER));
                        return;
                    case 5:
                        reactDropdownPickerManager.setTranslateY(i0v, C34901Hvb.A02(obj, obj, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER));
                        return;
                    case 6:
                        i0v.setEnabled(C34901Hvb.A1Z(obj, obj, true));
                        return;
                    case 7:
                        reactDropdownPickerManager.setShadowColor(i0v, C34901Hvb.A07(i0v, obj, -16777216));
                        return;
                    case '\b':
                        A1Z = C34901Hvb.A1Z(obj, obj, false);
                    ...
                    case '7':
                        return;
                    case '\n':
                        reactDropdownPickerManager.setOpacity(i0v, C34901Hvb.A02(obj, obj, 1.0f));
                        return;
                    case 11:
                        A1Z = C34901Hvb.A1Z(obj, obj, false);
                    ...
                    case LangUtils.HASH_SEED /* 17 */:
                        ...
                        return;
                    case 18:
                        reactDropdownPickerManager.setTestId(i0v, C34901Hvb.A0b(obj));
                        return;
                    case 19:
                        reactDropdownPickerManager.setZIndex(i0v, C34901Hvb.A02(obj, obj, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER));
                        return;
                    case 21:
                        A1Z = C34901Hvb.A1Z(obj, obj, false);
                        ...
                        return;
                    case 22:
                        reactDropdownPickerManager.setAccessibilityHint(i0v, C34901Hvb.A0b(obj));
                        return;
                    case 23:
                        reactDropdownPickerManager.setAccessibilityRole(i0v, C34901Hvb.A0b(obj));
                        return;
                    case 24:
                        reactDropdownPickerManager.setRenderToHardwareTexture(i0v, C34901Hvb.A1Z(obj, obj, false));
                        return;
                    case 25:
                        i0v.setRotation(C34901Hvb.A02(obj, obj, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER));
                        return;
                    case Rfc3492Idn.tmax /* 26 */:
                        reactDropdownPickerManager.setElevation(i0v, C34901Hvb.A02(obj, obj, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER));
                        return;
                    case 27:
                        reactDropdownPickerManager.setRole(i0v, C34901Hvb.A0b(obj));
                        return;
                    case 28:
                        A1Z = C34901Hvb.A1Z(obj, obj, false);
                    ...
                    case CameraRollManager.IMAGES_MEDIA_LATITUDE_LONGITUDE_DEPRECATED_API_LEVEL /* 29 */:
                        ...
                        return;
                    case 30:
                        reactDropdownPickerManager.setAccessibilityLiveRegion(i0v, C34901Hvb.A0b(obj));
                        return;
                    case 31:
                        i0v.A02 = C34901Hvb.A0W(i0v, obj);
                        return;
                    case ' ':
                        reactDropdownPickerManager.setItems(i0v, C34901Hvb.A0Q(obj));
                        return;
                    case '!':
                        A1Z = C34901Hvb.A1Z(obj, obj, false);
                    ...
                    case LangUtils.HASH_OFFSET /* 37 */:
                        reactDropdownPickerManager.setImportantForAccessibility(i0v, C34901Hvb.A0b(obj));
                        return;
                    case Rfc3492Idn.skew /* 38 */:
                        reactDropdownPickerManager.setTransform(i0v, C34901Hvb.A0Q(obj));
                        return;
                    case '\'':
                        reactDropdownPickerManager.setAccessibilityLabel(i0v, C34901Hvb.A0b(obj));
                        return;
                    case LineChartAxesView.AXIS_TICK_OFFSET /* 40 */:
                        reactDropdownPickerManager.setViewState(i0v, C34901Hvb.A0R(obj));
                        return;
                    case Seq.NULL_REFNUM /* 41 */:
                        reactDropdownPickerManager.setAccessibilityValue(i0v, C34901Hvb.A0R(obj));
                        return;
                    ...
                    case JITProfilePQR.MEGA_ZIP_NAME_PREFIX_LEN /* 46 */:
                        reactDropdownPickerManager.setBackgroundColor(i0v, C34901Hvb.A07(i0v, obj, 0));
                        return;
                    case AnimationSpecKt.IDLE_DURATION /* 50 */:
                        reactDropdownPickerManager.setAccessibilityActions(i0v, C34901Hvb.A0Q(obj));
                        return;
                    case '5':
                        reactDropdownPickerManager.setAccessibilityCollection(i0v, C34901Hvb.A0R(obj));
                        return;
                    case '6':
                        C38340K2d.A01(i0v, reactDropdownPickerManager, obj);
                        return;
                    case '8':
                        reactDropdownPickerManager.setAccessibilityCollectionItem(i0v, C34901Hvb.A0R(obj));
                        return;
                    default:
                        reactDropdownPickerManager.setNativeId(i0v, C34901Hvb.A0b(obj));
                        return;
                }
            case -1721943861:
