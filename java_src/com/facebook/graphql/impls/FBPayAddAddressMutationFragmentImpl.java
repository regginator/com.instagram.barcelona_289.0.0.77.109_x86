...
public final class FBPayAddAddressMutationFragmentImpl extends TreeJNI implements InterfaceC87174mZ {

    /* loaded from: classes3.dex */
    public final class PayAddMailingAddress extends TreeJNI implements InterfaceC87174mZ {
    ...
    @Override // com.facebook.pando.TreeJNI
    public final C114016gm[] getEdgeFields() {
        return C25920wp.A1a(PayAddMailingAddress.class, "pay_add_mailing_address(data:$data)");
    }
}
