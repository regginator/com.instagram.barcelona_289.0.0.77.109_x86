...
public class ReactHorizontalScrollContainerViewManager$$PropsSetter implements ViewManagerPropertyUpdater$ViewManagerSetter {
    ...
    */
    public final /* bridge */ /* synthetic */ void Cp7(View view, ViewManager viewManager, Object obj, String str) {
        ...
        switch (str.hashCode()) {
            case -1898517556:
                ...
                BaseViewManager.setPointerEventsFlag(c35036Hyg, enumC35931Iod, A1Z);
                return;
            case -1721943862:
                ...
                switch (c) {
                    case 4:
                        baseViewManager.setTranslateX(c35036Hyg, C34901Hvb.A02(obj, obj, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER));
                        return;
                    case 5:
                        baseViewManager.setTranslateY(c35036Hyg, C34901Hvb.A02(obj, obj, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER));
                        return;
                    case 6:
                        baseViewManager.setShadowColor(c35036Hyg, C34901Hvb.A07(c35036Hyg, obj, -16777216));
                        return;
                    case 7:
                        A1Z = C34901Hvb.A1Z(obj, obj, false);
                    ...
                    case '3':
                        return;
                    case '\t':
                        baseViewManager.setOpacity(c35036Hyg, C34901Hvb.A02(obj, obj, 1.0f));
                        return;
                    case '\n':
                        A1Z = C34901Hvb.A1Z(obj, obj, false);
                    ...
                    case '\r':
                        ...
                        return;
                    case 14:
                        c35036Hyg.setScaleX(C34901Hvb.A02(obj, obj, 1.0f));
                        return;
                    case 15:
                        c35036Hyg.setScaleY(C34901Hvb.A02(obj, obj, 1.0f));
                        return;
                    case 16:
                        baseViewManager.setTestId(c35036Hyg, C34901Hvb.A0b(obj));
                        return;
                    case LangUtils.HASH_SEED /* 17 */:
                        baseViewManager.setZIndex(c35036Hyg, C34901Hvb.A02(obj, obj, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER));
                        return;
                    case 19:
                        c35036Hyg.setRemoveClippedSubviews(C34901Hvb.A1Z(obj, obj, false));
                        return;
                    case 20:
                        A1Z = C34901Hvb.A1Z(obj, obj, false);
                        ...
                        return;
                    case 21:
                        baseViewManager.setAccessibilityHint(c35036Hyg, C34901Hvb.A0b(obj));
                        return;
                    case 22:
                        baseViewManager.setAccessibilityRole(c35036Hyg, C34901Hvb.A0b(obj));
                        return;
                    case 23:
                        baseViewManager.setRenderToHardwareTexture(c35036Hyg, C34901Hvb.A1Z(obj, obj, false));
                        return;
                    case 24:
                        c35036Hyg.setRotation(C34901Hvb.A02(obj, obj, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER));
                        return;
                    case 25:
                        baseViewManager.setElevation(c35036Hyg, C34901Hvb.A02(obj, obj, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER));
                        return;
                    case Rfc3492Idn.tmax /* 26 */:
                        baseViewManager.setRole(c35036Hyg, C34901Hvb.A0b(obj));
                        return;
                    case 27:
                        A1Z = C34901Hvb.A1Z(obj, obj, false);
                    ...
                    case CameraRollManager.IMAGES_MEDIA_LATITUDE_LONGITUDE_DEPRECATED_API_LEVEL /* 29 */:
                        baseViewManager.setAccessibilityLiveRegion(c35036Hyg, C34901Hvb.A0b(obj));
                        return;
                    case 30:
                        A1Z = C34901Hvb.A1Z(obj, obj, false);
                    ...
                    case 31:
                        ...
                        return;
                    case '\"':
                        baseViewManager.setImportantForAccessibility(c35036Hyg, C34901Hvb.A0b(obj));
                        return;
                    case '#':
                        baseViewManager.setTransform(c35036Hyg, C34901Hvb.A0Q(obj));
                        return;
                    case Rfc3492Idn.base /* 36 */:
                        baseViewManager.setAccessibilityLabel(c35036Hyg, C34901Hvb.A0b(obj));
                        return;
                    case LangUtils.HASH_OFFSET /* 37 */:
                        baseViewManager.setViewState(c35036Hyg, C34901Hvb.A0R(obj));
                        return;
                    case Rfc3492Idn.skew /* 38 */:
                        baseViewManager.setAccessibilityValue(c35036Hyg, C34901Hvb.A0R(obj));
                        return;
                    ...
                    case Seq.RefTracker.REF_OFFSET /* 42 */:
                        baseViewManager.setBackgroundColor(c35036Hyg, C34901Hvb.A07(c35036Hyg, obj, 0));
                        return;
                    case JITProfilePQR.MEGA_ZIP_NAME_PREFIX_LEN /* 46 */:
                        baseViewManager.setAccessibilityActions(c35036Hyg, C34901Hvb.A0Q(obj));
                        return;
                    case '1':
                        baseViewManager.setAccessibilityCollection(c35036Hyg, C34901Hvb.A0R(obj));
                        return;
                    case AnimationSpecKt.IDLE_DURATION /* 50 */:
                        C38340K2d.A01(c35036Hyg, baseViewManager, obj);
                        return;
                    case '4':
                        baseViewManager.setAccessibilityCollectionItem(c35036Hyg, C34901Hvb.A0R(obj));
                        return;
                    default:
                        baseViewManager.setNativeId(c35036Hyg, C34901Hvb.A0b(obj));
                        return;
                }
            case -1721943861:
    ...
    public final void B5D(Map map) {
        ...
        map.put("removeClippedSubviews", A0f);
