...
public enum IGPBIAProfileBrowseTypeEnum implements Parcelable {
    ...
    PROFILE_BROWSE_HALF_SHEET_WITH_DISMISS("PROFILE_BROWSE_HALF_SHEET_WITH_DISMISS");
    ...
    static {
        ...
        for (IGPBIAProfileBrowseTypeEnum iGPBIAProfileBrowseTypeEnum : values) {
            A0o.put(iGPBIAProfileBrowseTypeEnum.A00, iGPBIAProfileBrowseTypeEnum);
        }
        A01 = A0o;
        CREATOR = C150678fF.A0F(9);
    }
