...
import p000X.InterfaceC87934nx;
/* loaded from: classes2.dex */
public final class LinkWithText extends C0SZ implements Parcelable, InterfaceC87934nx {
    public static final Parcelable.Creator CREATOR = new PCreatorCreatorShape8S0000000_I2_8(32);
    public final String A00;
    public final String A01;

    @Override // p000X.InterfaceC87934nx
    public final LinkWithText Czm() {
        return this;
    }
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof LinkWithText) {
                ...
                if (!C0OR.A0I(this.A00, linkWithText.A00) || !C0OR.A0I(this.A01, linkWithText.A01)) {
                }
            }
            return false;
        }
