...
public final class MetaGalleryOptInStateMutationResponseImpl extends TreeJNI implements InterfaceC87174mZ {

    /* loaded from: classes2.dex */
    public final class MetaGallerySetOptInStatus extends TreeJNI implements InterfaceC87174mZ {
        ...
        @Override // com.facebook.pando.TreeJNI
        public final C114016gm[] getEdgeFields() {
            return C25920wp.A1a(Albums.class, "albums(after:$albums_after,first:$albums_first)");
        }
    }

    @Override // com.facebook.pando.TreeJNI
    public final C114016gm[] getEdgeFields() {
        return C25920wp.A1a(MetaGallerySetOptInStatus.class, "meta_gallery_set_opt_in_status(opt_in_status:$opt_in_state)");
    }
}
