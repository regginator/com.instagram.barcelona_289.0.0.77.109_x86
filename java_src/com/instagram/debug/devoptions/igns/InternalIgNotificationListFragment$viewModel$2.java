...
public final class InternalIgNotificationListFragment$viewModel$2 extends AbstractC09600Ac implements C0ZU {
    ...
    public final C8b1 invoke() {
        return new InternalIgNotificationListViewModel.Factory(C25920wp.A0Y(this.this$0.userSession$delegate));
    }
}
