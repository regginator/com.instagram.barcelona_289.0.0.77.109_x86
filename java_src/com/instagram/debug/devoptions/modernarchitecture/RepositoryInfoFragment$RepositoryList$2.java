...
public final class RepositoryInfoFragment$RepositoryList$2 extends AbstractC09600Ac implements C0YS {
    ...
    public final void invoke(C8b6 c8b6, int i) {
        this.$tmp0_rcvr.RepositoryList(this.$repositoriesInfo, this.$modifier, c8b6, C121146t8.A00(this.$$changed), this.$$default);
    }
