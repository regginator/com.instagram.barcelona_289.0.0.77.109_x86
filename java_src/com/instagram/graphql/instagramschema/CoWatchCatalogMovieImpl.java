...
public final class CoWatchCatalogMovieImpl extends TreeJNI implements InterfaceC87174mZ {
    ...
    /* loaded from: classes2.dex */
    public final class TrailersAndMore extends TreeJNI implements InterfaceC87174mZ {
        @Override // com.facebook.pando.TreeJNI
        public final Class[] getInlineClasses() {
    ...
    public final C114016gm[] getEdgeFields() {
        return new C114016gm[]{C25940wr.A0C(Poster.class, "poster", false), C25940wr.A0C(CoverPhoto.class, "cover_photo", false), C25940wr.A0C(Video.class, MediaStreamTrack.VIDEO_TRACK_KIND, false), C25940wr.A0C(TrailersAndMore.class, "trailers_and_more", true)};
    }
}
