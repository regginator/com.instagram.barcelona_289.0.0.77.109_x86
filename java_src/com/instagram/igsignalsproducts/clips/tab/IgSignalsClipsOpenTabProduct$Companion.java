...
public final class IgSignalsClipsOpenTabProduct$Companion {
    ...
    */
    public final Object A00(UserSession userSession, String str, InterfaceC148208Yc interfaceC148208Yc) {
        ...
        int i;
        CXE cxe;
        if (KtCImplShape4S0301000_I2_3.A00(8, interfaceC148208Yc)) {
            ...
            if ((i2 & Process.WAIT_RESULT_TIMEOUT) != 0) {
                ...
                if (i == 0) {
                    if (i == 1) {
                        cxe = (CXE) ktCImplShape4S0301000_I2_3.A01;
                        C12070Oz.A00(obj);
                    } else {
                        throw C25920wp.A0b();
                    }
                    ...
                    C12070Oz.A00(obj);
                    cxe = new CXE(userSession, str);
                    C25185DHg A0V = C22187Bs5.A0V(userSession);
                    IDxRImplShape196S0000000_4_I2 iDxRImplShape196S0000000_4_I2 = new IDxRImplShape196S0000000_4_I2(this, 9);
                    ktCImplShape4S0301000_I2_3.A01 = cxe;
                    ktCImplShape4S0301000_I2_3.A00 = 1;
                    obj = A0V.A00(cxe, ktCImplShape4S0301000_I2_3, iDxRImplShape196S0000000_4_I2);
                    if (obj == enumC35959IpB) {
                        return enumC35959IpB;
                    }
                }
                cxe.A00 = (C25479DUt) obj;
                return cxe;
            }
        }
        ktCImplShape4S0301000_I2_3 = new KtCImplShape4S0301000_I2_3(this, interfaceC148208Yc, 8);
        Object obj2 = ktCImplShape4S0301000_I2_3.A02;
        EnumC35959IpB enumC35959IpB2 = EnumC35959IpB.COROUTINE_SUSPENDED;
        i = ktCImplShape4S0301000_I2_3.A00;
        if (i == 0) {
        }
        cxe.A00 = (C25479DUt) obj2;
        return cxe;
    }
}
