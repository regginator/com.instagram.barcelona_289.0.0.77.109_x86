...
public final class FollowRequestsGraphQLDataSource extends FollowRequestsNetworkDataSource {
    ...
    */
    public final Object A02(String str, InterfaceC148208Yc interfaceC148208Yc, boolean z) {
        ...
        Object obj;
        Integer num;
        FollowRequestsGraphQLDataSource followRequestsGraphQLDataSource;
        ...
        ?? r1;
        if (KtCImplShape4S0301000_I2_3.A00(31, interfaceC148208Yc)) {
            ...
            if ((i2 & Process.WAIT_RESULT_TIMEOUT) != 0) {
                ...
                if (i == 0) {
                    if (i == 1) {
                        followRequestsGraphQLDataSource = (FollowRequestsGraphQLDataSource) ktCImplShape4S0301000_I2_3.A01;
                        C12070Oz.A00(obj2);
                    } else {
                    ...
                    followRequestsGraphQLDataSource = this;
                }
                abstractC69863c2 = (AbstractC69863c2) obj2;
                GZM gzm = followRequestsGraphQLDataSource.A01.A01;
                GZM.A00(gzm);
                if (!(abstractC69863c2 instanceof C1nC) && (c1nC = (C1nC) abstractC69863c2) != null && (c5u4 = (C5u4) c1nC.A00) != null && (treeJNI = (TreeJNI) c5u4.A01) != null && (treeValue = treeJNI.getTreeValue(AnonymousClass000.A00(HttpStatus.SC_GONE), PendingFollowsResponseImpl.XdtApiV1FriendshipsPending.class)) != null) {
                    ...
                    if (treeValue2 != null && (treeList = treeValue2.getTreeList("suggestions", PendingFollowsResponseImpl.XdtApiV1FriendshipsPending.SuggestedUsers.Suggestions.class)) != null) {
                        ...
                        while (it.hasNext()) {
                            ...
                            if (treeValue3 != null && (rowUserImpl = (RowUserImpl) treeValue3.reinterpret(RowUserImpl.class)) != null) {
                                User A01 = followRequestsGraphQLDataSource.A01(rowUserImpl);
                                A01.A03 = EnumC29765FeM.FollowStatusNotFollowing;
                                A01.A2P(false);
                                HNE hne = new HNE();
                                hne.A04 = A01;
                                ...
                                if (treeList2 != null) {
                                    ...
                                    while (it2.hasNext()) {
                                        r1.add(followRequestsGraphQLDataSource.A03.A03(C28353Emo.A0X(it2), true, false));
                                    }
                                } else {
                                    r1 = C0ZV.A00;
                                }
                    ...
                    if (treeList3 != null) {
                        ...
                        while (it3.hasNext()) {
                            ...
                            r3.add(followRequestsGraphQLDataSource.A01(rowUserImpl2));
                        }
                    } else {
                        r3 = C0ZV.A00;
                    }
                    c23400CcZ = new C23401Cca(new KtCSuperShape0S0301000_I2(AnonymousClass006.A01, (List) r3, (List) r5, treeValue.getIntValue(AnonymousClass000.A00(79))));
                } else {
                    if ((abstractC69863c2 instanceof C1nD) && (c1nD = (C1nD) abstractC69863c2) != null) {
                        obj = c1nD.A00;
                    }
                    c23400CcZ = new C23400CcZ(String.valueOf(obj));
                }
                gzm.A06();
                return c23400CcZ;
            }
        }
        ktCImplShape4S0301000_I2_3 = new KtCImplShape4S0301000_I2_3(this, interfaceC148208Yc, 31);
        ...
        GZM gzm2 = followRequestsGraphQLDataSource.A01.A01;
        GZM.A00(gzm2);
    ...
    public /* synthetic */ FollowRequestsGraphQLDataSource(CCS ccs, UserSession userSession) {
        super(userSession);
    ...
    private final User A01(RowUserImpl rowUserImpl) {
