...
public class DistillerySubscribeExecutor extends SubscribeExecutor {
    public static DistillerySubscribeExecutor getInstance(final UserSession userSession) {
        return (DistillerySubscribeExecutor) userSession.A01(DistillerySubscribeExecutor.class, new C0ZU() { // from class: com.instagram.realtimeclient.requeststream.DistillerySubscribeExecutor$$ExternalSyntheticLambda0
            @Override // p000X.C0ZU
    ...
    public JSONObject buildHeaderJson(GraphQLSubscriptionRequestStub graphQLSubscriptionRequestStub, String str) {
        ...
        try {
            ...
            A0s.put("method", C073900b.A0L("IGGQLS:", iGGraphQLSubscriptionRequestStringStub.getQueryName().toUpperCase(Locale.ENGLISH)));
            return A0s;
    ...
    public JSONObject buildPayload(GraphQLSubscriptionRequestStub graphQLSubscriptionRequestStub, String str) {
        ...
        try {
            ...
            A0s.put(RealtimeSubscription.INPUT_DATA, A0s2);
    ...
    public static /* synthetic */ DistillerySubscribeExecutor lambda$getInstance$0(UserSession userSession) {
        return new DistillerySubscribeExecutor(userSession, C6N7.A00(userSession));
    }

    public DistillerySubscribeExecutor(UserSession userSession, C32614Gsp c32614Gsp) {
        super(userSession, c32614Gsp);
    }

    public DistillerySubscribeExecutor(MYC myc, InterfaceC095109s interfaceC095109s, C32614Gsp c32614Gsp, C8VP c8vp, long j) {
