...
public final class KeyAttestationClient {
    ...
    public final C118896p2 A01;
    public final C01R A02;
    public final C32245Glt A03;
    public final String A04;

    public KeyAttestationClient(C118896p2 c118896p2, C01R c01r, C32245Glt c32245Glt, String str) {
    ...
    */
    public static final Object A00(AbstractC18180if abstractC18180if, KeyAttestationClient keyAttestationClient, String str, String str2, InterfaceC148208Yc interfaceC148208Yc) {
        KtCImplShape10S0201000_I2_8 ktCImplShape10S0201000_I2_8;
        int i;
        AbstractC69863c2 abstractC69863c2;
        if (KtCImplShape10S0201000_I2_8.A00(22, interfaceC148208Yc)) {
            ...
            if ((i2 & Process.WAIT_RESULT_TIMEOUT) != 0) {
                ...
                if (i == 0) {
                    ...
                    A0O.A0P("attestation/create_android_keystore/");
                    A0O.A0U("app_scoped_device_id", str);
                    A0O.A0U("key_hash", str2);
                    C32944GzF A0T = C25920wp.A0T(A0O, C5pO.class, C122496vN.class);
                    ktCImplShape10S0201000_I2_8.A00 = 1;
                    obj = C70613im.A01(A0T, ktCImplShape10S0201000_I2_8, 669957587, 0, 14);
                ...
                if (abstractC69863c2 instanceof C1nD) {
                    throw new Exception() { // from class: X.6A6
                    };
                }
                throw C4UK.A00();
            }
        }
        ktCImplShape10S0201000_I2_8 = new KtCImplShape10S0201000_I2_8(keyAttestationClient, interfaceC148208Yc, 22, 42);
