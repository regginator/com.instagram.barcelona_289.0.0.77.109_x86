...
public final class CXPCommentCreateMutationResponseImpl extends TreeJNI implements InterfaceC87174mZ {

    /* loaded from: classes2.dex */
    public final class XcxpDispatchCommentCreate extends TreeJNI implements InterfaceC87174mZ {
    ...
    @Override // com.facebook.pando.TreeJNI
    public final C114016gm[] getEdgeFields() {
        return C25920wp.A1b(XcxpDispatchCommentCreate.class, "xcxp_dispatch_comment_create(destinations:[$destination],params:$params)");
    }
}
