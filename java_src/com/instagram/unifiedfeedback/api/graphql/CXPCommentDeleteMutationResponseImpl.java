...
public final class CXPCommentDeleteMutationResponseImpl extends TreeJNI implements InterfaceC87174mZ {

    /* loaded from: classes2.dex */
    public final class XcxpDispatchCommentDelete extends TreeJNI implements InterfaceC87174mZ {
    ...
    @Override // com.facebook.pando.TreeJNI
    public final C114016gm[] getEdgeFields() {
        return C25920wp.A1b(XcxpDispatchCommentDelete.class, "xcxp_dispatch_comment_delete(destinations:[$destination],params:$params)");
    }
}
