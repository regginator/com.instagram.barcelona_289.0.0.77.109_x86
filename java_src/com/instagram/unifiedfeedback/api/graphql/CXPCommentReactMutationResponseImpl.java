...
public final class CXPCommentReactMutationResponseImpl extends TreeJNI implements InterfaceC87174mZ {

    /* loaded from: classes2.dex */
    public final class XcxpDispatchCommentReact extends TreeJNI implements InterfaceC87174mZ {
    ...
    @Override // com.facebook.pando.TreeJNI
    public final C114016gm[] getEdgeFields() {
        return C25920wp.A1b(XcxpDispatchCommentReact.class, "xcxp_dispatch_comment_react(destinations:[$destination],params:$params)");
    }
}
