...
public final class ViewLeadOpportunityDetailsUrlHandlerActivity extends BaseFragmentActivity {
    ...
    public final void onCreate(Bundle bundle) {
        int i;
        Bundle A0B;
        int A00 = C21950pH.A00(1416655291);
        ...
        if (intent != null && (A0B = C25960wt.A0B(intent)) != null) {
            ...
            if (A0e != null && A0e.length() != 0) {
                ...
                if (!(getSession() instanceof UserSession)) {
                    ...
                    C0OR.A0B(session, 1);
                    C25920wp.A18(C69803bw.A03(session, "com.bloks.www.ig.smb.services.lead_gen.opportunity_details", C69953cB.A02("lead_opportunity_id", lastPathSegment)), this, session);
                }
            } else {
                finish();
            }
