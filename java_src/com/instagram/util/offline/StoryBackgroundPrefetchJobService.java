...
public class StoryBackgroundPrefetchJobService extends BackgroundPrefetchJobService {
    ...
    public final void A02() {
        ...
        if ((A0a instanceof UserSession) && C32710Guq.A04()) {
            ...
            if (C70763jC.A0E(C0TD.A05, A0a, 36320833321244948L)) {
                C37511yy A03 = C70173gG.A03(A02);
                C0OR.A0B(A03, 1);
                List A00 = C2NU.A00(A03);
                C0OR.A0B(A00, 0);
        ...
        if (longValue > 0) {
            Class<?> cls = getClass();
            C0OR.A0B(cls, 2);
            C31776GYo.A00(C18460jE.A00).A02(new GSa(cls, R.id.story_background_prefetch_job_scheduler_id, 1, 0L, longValue, true, false));
        }
    }
}
