...
public final class LiveChatNonce extends C0SZ {
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof LiveChatNonce) {
                ...
                if (!C0OR.A0I(this.A02, liveChatNonce.A02) || !C0OR.A0I(this.A00, liveChatNonce.A00) || !C0OR.A0I(this.A01, liveChatNonce.A01)) {
                }
            }
            return false;
        }
    ...
    public final String toString() {
        StringBuilder A0m = C25940wr.A0m("LiveChatNonce(userId=");
        A0m.append(this.A02);
        A0m.append(", nonce=");
        A0m.append(this.A00);
        A0m.append(", supportUid=");
        A0m.append(this.A01);
