...
public interface VideoEncoder {
    ...
    public class EncodeInfo {
        ...
        public final VideoFrameEncodingInfo videoFrameEncodingInfo;

        public EncodeInfo(EncodedImage.FrameType[] frameTypeArr, VideoFrameEncodingInfo videoFrameEncodingInfo) {
            this.frameTypes = frameTypeArr;
            this.videoFrameEncodingInfo = videoFrameEncodingInfo;
        }
    }
