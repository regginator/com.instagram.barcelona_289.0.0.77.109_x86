...
public final class AnonymousClass562 extends Fragment implements C8ZP {
    ...
    public final void A5k(final LifecycleCallback lifecycleCallback, final String str) {
        ...
        if (!map.containsKey(str)) {
            ...
            if (this.A00 > 0) {
                new HandlerC93074yn(Looper.getMainLooper()).post(new Runnable() { // from class: X.7zR
                    @Override // java.lang.Runnable
                    public final void run() {
                        Bundle bundle;
                        AnonymousClass562 anonymousClass562 = this;
                        if (anonymousClass562.A00 > 0) {
                            LifecycleCallback lifecycleCallback2 = lifecycleCallback;
                            Bundle bundle2 = anonymousClass562.A01;
                            if (bundle2 != null) {
                        ...
                        if (anonymousClass562.A00 >= 2) {
                            lifecycleCallback.A03();
                        }
                        if (anonymousClass562.A00 >= 3) {
                            lifecycleCallback.A02();
                        }
                        if (anonymousClass562.A00 >= 4) {
    ...
    @Override // p000X.C8ZP
    public final /* synthetic */ Activity As6() {
        return getActivity();
    }
    ...
    public final void onCreate(Bundle bundle) {
        Bundle bundle2;
        int A02 = C21950pH.A02(-544826621);
        ...
        C21950pH.A09(-958236405, A02);
    }

    @Override // androidx.fragment.app.Fragment
    public final void onDestroy() {
        int A02 = C21950pH.A02(1576057034);
        super.onDestroy();
        this.A00 = 5;
        Iterator A0z = C91514uR.A0z(this.A02);
        while (A0z.hasNext()) {
        ...
        C21950pH.A09(-1150198533, A02);
    }

    @Override // androidx.fragment.app.Fragment
    public final void onResume() {
        int A02 = C21950pH.A02(-1059664708);
        super.onResume();
        this.A00 = 3;
        Iterator A0z = C91514uR.A0z(this.A02);
        while (A0z.hasNext()) {
        ...
        C21950pH.A09(2018005250, A02);
    }

    @Override // androidx.fragment.app.Fragment
    public final void onStart() {
        int A02 = C21950pH.A02(1474959548);
        super.onStart();
        this.A00 = 2;
        Iterator A0z = C91514uR.A0z(this.A02);
        while (A0z.hasNext()) {
        ...
        C21950pH.A09(1912662489, A02);
    }

    @Override // androidx.fragment.app.Fragment
    public final void onStop() {
        int A02 = C21950pH.A02(-949417288);
        super.onStop();
        this.A00 = 4;
        Iterator A0z = C91514uR.A0z(this.A02);
        while (A0z.hasNext()) {
