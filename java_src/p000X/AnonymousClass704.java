...
public final class AnonymousClass704 {
    public static final Modifier A00 = C128347Gt.A0E(Modifier.A00, 24);

    /* JADX WARN: Code restructure failed: missing block: B:21:0x008b, code lost:
        if (java.lang.Float.isInfinite(p000X.C7F9.A00(r6)) != false) goto L27;
     */
    ...
    */
    public static final void A00(C8b6 c8b6, Modifier modifier, AbstractC120556s0 abstractC120556s0, String str, int i, int i2, long j) {
        ...
        Modifier A0a = C8b6.A0a(c8b6, modifier, 1786787912, i2);
        if ((i2 & 8) != 0) {
            j2 = C41572Lxr.A04(C25970wu.A00(c8b6.AEC(C6WU.A00)), C123386wo.A00(c8b6).A0g);
        }
        if (j2 == C41572Lxr.A06) {
            A0T = null;
        } else {
        ...
        Modifier A01 = Modifier.A01(c8b6, 436065286);
        ...
        if (str != null) {
            ...
            if (A12 || A13 == C7C4.A00) {
                A13 = new KtLambdaShape6S1000000_I2(str, 23);
                c129457Sw.A14(A13);
            }
        ...
        if (abstractC120556s0.A01() != C7F9.A01) {
            ...
            AKF = c8b6.AKF();
            if (AKF == null) {
                AKF.DAG(new KtLambdaShape0S1202100_I2(A0a, abstractC120556s0, str, i, i2, 1, j2));
                return;
            }
            return;
        }
