...
public final class AnonymousClass927 extends LAM {
    @Comparable(type = 13)
    ...
    */
    public final boolean A0V(MCD mcd, boolean z) {
        if (this != mcd) {
            if (mcd != null && getClass() == mcd.getClass()) {
                AnonymousClass927 anonymousClass927 = (AnonymousClass927) mcd;
                C159238yd c159238yd = this.A01;
                C159238yd c159238yd2 = anonymousClass927.A01;
                if (c159238yd == null) {
                    if (c159238yd2 != null) {
                        return false;
                    }
                ...
                C8q1 c8q1 = this.A02;
                C8q1 c8q12 = anonymousClass927.A02;
                if (c8q1 != null) {
                ...
                InterfaceC21697Bjy interfaceC21697Bjy2 = anonymousClass927.A00;
    ...
    public AnonymousClass927() {
        super("ViewpointViewtimeRegisterComponent");
    }
    ...
    public final boolean A0U(MCD mcd, MCD mcd2, AbstractC41943MHo abstractC41943MHo, AbstractC41943MHo abstractC41943MHo2) {
        C159238yd c159238yd;
        AnonymousClass927 anonymousClass927 = (AnonymousClass927) mcd;
        AnonymousClass927 anonymousClass9272 = (AnonymousClass927) mcd2;
        C159238yd c159238yd2 = null;
        if (anonymousClass927 == null) {
            c159238yd = null;
        } else {
            c159238yd = anonymousClass927.A01;
        }
        if (anonymousClass9272 != null) {
            c159238yd2 = anonymousClass9272.A01;
        }
        return C91554uV.A1Y(c159238yd, c159238yd2);
    }
