...
public final class B8U implements InterfaceC21977Boa {
    ...
    public final void CKu(B7P b7p, C20562B8r c20562B8r, String str, boolean z) {
        ...
        String BAt = this.A03.BAt();
        if (c4u2 instanceof InterfaceC22120Bqz) {
            c23180ri = InterfaceC22120Bqz.A00(b7p, c4u2);
        } else {
            c23180ri = null;
        }
        C19737All.A02(c4u2, c23180ri, b7p, enumC170679fZ, c20562B8r, userSession, "sfplt_in_header", BAt, c20562B8r.getPosition(), A1Y);
    ...
    public B8U(C4u2 c4u2, InterfaceC21977Boa interfaceC21977Boa, UserSession userSession, InterfaceC22085BqK interfaceC22085BqK) {
        C25920wp.A1R(interfaceC21977Boa, userSession);
        C25920wp.A1P(c4u2, 3, interfaceC22085BqK);
