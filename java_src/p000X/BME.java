...
public final class BME implements C8Z8 {
    ...
    private final InterfaceC150228e9 A00(B7P b7p, C20562B8r c20562B8r) {
        int position;
        String str;
        ...
        if (A05 != null) {
            ...
            A05.A6N = C4V2.A08(A0m, C25930wq.A0m("last_actions", str2), C25930wq.A0m("scroll_velocity", String.valueOf(A00.A01())));
            A05.A1M = Boolean.valueOf(C67023Pl.A00(userSession));
            C0OR.A0B(b7p, 0);
            if (!b7p.BSR() || (str = b7p.A0f.A4i) == null || str.length() == 0) {
                str = b7p.A0f.A4Y;
                C0OR.A06(str);
            }
            A05.A0w = Boolean.valueOf(this.A04.A03(str));
            return new BAP(A05);
        }
        return null;
    }
    ...
    public BME(C19670Akf c19670Akf, C4u2 c4u2, UserSession userSession, InterfaceC22085BqK interfaceC22085BqK, C3a7 c3a7, C19530AiN c19530AiN) {
