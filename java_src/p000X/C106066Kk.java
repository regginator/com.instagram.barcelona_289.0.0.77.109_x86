...
public final class C106066Kk {
    public static Object A00(C5vO c5vO, C70723j8 c70723j8) {
        ...
        c31729GVy.A05("sensitive_tax_id_number", A0y);
        if (A0j != null) {
            c31729GVy.A05("payment_dev_cycle", A0j);
        }
        C32944GzF c32944GzF = new C32944GzF(FL0.A00(new IDxCallableShape265S0100000_5_I2(c31729GVy, 11), 658, 2).A02(new IDxContinuationShape512S0100000_5_I2(null, 3), 747, 2, true, false).A02(new IDxContinuationShape147S0000000_2_I2(3), 748, 2, false, false), "FetchPaymentToken", AnonymousClass000.A00(6));
        c32944GzF.A00 = new IDxACallbackShape17S0300000_2_I2(2, c5vO, A0P2, A0P);
