...
public final class C139187ti implements InterfaceC34720HsN {
    ...
    public final boolean Cso(UserSession userSession) {
        if (C70763jC.A0E(C25930wq.A0J(userSession), userSession, 36323689473515523L) && C25980wv.A08() >= C25930wq.A04(C70173gG.A01(userSession), AnonymousClass000.A00(54))) {
            return true;
        }
        return false;
    }
