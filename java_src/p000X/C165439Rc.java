...
public final class C165439Rc extends C5MH implements InterfaceC22031BpS {
    @Override // p000X.InterfaceC22031BpS
    public final InterfaceC21955BoE BME() {
        return (InterfaceC21955BoE) getTreeValueByHashCode(-131535666, C165429Rb.class);
    }
    ...
    public final C157798w9 D3h(C19510Ai2 c19510Ai2) {
        ...
        C157788w8 c157788w8 = null;
        if (A0F != null) {
            subscriptionStickerDict = A0F.D3D(c19510Ai2);
        } else {
            subscriptionStickerDict = null;
        }
        StickerTraySurface A0D = C150628fA.A0D(this, C21046BXy.A00);
        InterfaceC21955BoE BME = BME();
        if (BME != null) {
            c157788w8 = BME.D3g();
        }
        return new C157798w9(A0D, subscriptionStickerDict, c157788w8, A0S, A0L, A0M, A0T2, C150628fA.A0Q(this), C150628fA.A0N(this), C150628fA.A0O(this), C150628fA.A0P(this), A0R, A0S2, A0W, A0T, A0X, A0c, A0i, A0l, A0d, A0a, A0k);
    }
    ...
    public final C157798w9 D3i(InterfaceC21237BcR interfaceC21237BcR) {
        return D3h(C19510Ai2.A00(interfaceC21237BcR));
    }
