...
public final class C20090Av4 implements InterfaceC21886Bn7 {
    ...
    public final C32944GzF Amk(UserSession userSession, boolean z) {
        ...
        return C25940wr.A0O(A0O, "trend_id", str);
    }
    ...
    public final C32944GzF BFq(UserSession userSession, String str) {
        ...
        return C25940wr.A0O(A0O, "trend_id", str2);
    }
