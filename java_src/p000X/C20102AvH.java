...
public final class C20102AvH implements InterfaceC21886Bn7 {
    ...
    public final C32944GzF Amk(UserSession userSession, boolean z) {
        ...
        A0O.A0P("discover/discover_similar_clips/");
        A0O.A0U("seed_media_id", str);
        A0O.A0U("author_id", str2);
    ...
    public final C32944GzF BFq(UserSession userSession, String str) {
        ...
        C32422GpQ A0O = C25920wp.A0O(userSession);
        A0O.A0P("discover/discover_similar_clips/");
        A0O.A0U("seed_media_id", str2);
        A0O.A0U("author_id", str3);
    ...
    public C20102AvH(String str, String str2) {
        this.A01 = str;
        this.A00 = str2;
    }
