...
public final class C26747DxX implements InterfaceC42329Mc8 {
    ...
    public final void CNg(String str, boolean z) {
        this.A01.A0U(z);
        this.A05.A00 = str;
        if (this.A04.A00 != null && this.A02.getAndSet(false)) {
            this.A03.invoke();
        }
    }

    public C26747DxX(InterfaceC27896EfH interfaceC27896EfH, C25491DVm c25491DVm, AtomicBoolean atomicBoolean, C0ZU c0zu, C0OE c0oe, C0OE c0oe2) {
        this.A01 = c25491DVm;
        this.A05 = c0oe;
        this.A04 = c0oe2;
