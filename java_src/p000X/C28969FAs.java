...
public final class C28969FAs extends AbstractC28456EqC implements InterfaceC34724HsS, InterfaceC87894nt, InterfaceC34538HpJ, AbsListView.OnScrollListener, InterfaceC34544HpP {
    ...
    public final void Bq0(Reel reel, GradientSpinnerAvatarView gradientSpinnerAvatarView) {
        ...
        ATl aTl = this.A08;
        aTl.A0C = this.A09;
        C28352Emn.A13(getActivity(), gradientSpinnerAvatarView.getAvatarBounds(), aTl, this, 8);
    ...
    public final void CPb(User user) {
        ...
        giz.A01(this, user, "fundraiser_donors_list", false, this.A00.A0c());
    }
    ...
    private void A01() {
        if (this.A01 != null) {
            ...
            String str = C18995AYj.A01(EnumC171099gG.A0Q, this.A01.A0Y()).A0D().A00.A08;
            String str2 = this.A06.A00;
            C32422GpQ A0M = C25930wq.A0M(userSession);
            A0M.A0P("media/story_fundraiser_donations/");
            A0M.A0U("fundraiser_id", str);
            A0M.A0U("media_id", A35);
            A0M.A0H(C29921Wb.class, C3QR.class);
            if (str2 != null) {
                A0M.A0U("max_id", str2);
            }
            C32944GzF A08 = A0M.A08();
            C32944GzF.A01(A08, this, 47);
            schedule(A08);
        }
    }
    ...
    */
    public static void A02(C28969FAs c28969FAs) {
        boolean z;
    ...
    public final void CA3(GY7 gy7) {
        ...
        c31414GGc.A00(this.A00, new IDxDelegateShape281S0200000_5_I2(0, gy7, this), user, "reel_fundraiser_donors_list");
    }

    @Override // p000X.InterfaceC34538HpJ
    public final void CEo() {
        C21940pG.A00(this.A02, 1738277304);
    }

    @Override // p000X.InterfaceC34724HsS
    public final void CVC(GY7 gy7) {
        C31735GWj.A02(this.A04, gy7.A0F.getId(), "reel_fundraiser_donors_list", "reel_fundraiser_donors_list");
    ...
    public final void configureActionBar(InterfaceC22080BqF interfaceC22080BqF) {
        interfaceC22080BqF.setTitle(requireContext().getString(2131834218));
        C32400Gp1.A0M(interfaceC22080BqF);
    }

    @Override // androidx.fragment.app.Fragment
    public final void onCreate(Bundle bundle) {
        int A02 = C21950pH.A02(2051348439);
    ...
    public final void onResume() {
        ...
        C21950pH.A09(1938543052, A02);
    }

    @Override // android.widget.AbsListView.OnScrollListener
    public final void onScroll(AbsListView absListView, int i, int i2, int i3) {
        int A03 = C21950pH.A03(-571115851);
        this.A0A.onScroll(absListView, i, i2, i3);
        C21950pH.A0A(1094776836, A03);
    }

    @Override // android.widget.AbsListView.OnScrollListener
    public final void onScrollStateChanged(AbsListView absListView, int i) {
        int A03 = C21950pH.A03(1552627439);
        this.A0A.onScrollStateChanged(absListView, i);
        C21950pH.A0A(1805477474, A03);
    }

    @Override // androidx.fragment.app.Fragment
    public final void onStart() {
        int A02 = C21950pH.A02(-261637659);
        super.onStart();
        A02(this);
        C21950pH.A09(-125315500, A02);
    }
