...
public final class C35346IQp extends AbstractC36623J6a {
    public final LiveState A00;
    public final ServicePlayerState A01;
    public final JDU A02;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C35346IQp(LiveState liveState, ServicePlayerState servicePlayerState, JGR jgr, JDU jdu, Integer num) {
        super(jgr);
