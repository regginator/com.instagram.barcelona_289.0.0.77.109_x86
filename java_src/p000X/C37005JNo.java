...
public final class C37005JNo {
    public final int A00;
    public final int A01;
    public final long A02;
    public final JIZ A03;
    ...
    public C37005JNo(JIZ jiz, int[] iArr, int[] iArr2, long[] jArr, long[] jArr2, int i, long j) {
        int length = iArr.length;
        int length2 = jArr2.length;
        C37418JdU.A01(C25930wq.A1W(length, length2));
        int length3 = jArr.length;
        C37418JdU.A01(C25930wq.A1W(length3, length2));
        int length4 = iArr2.length;
        C37418JdU.A01(length4 == length2);
        this.A03 = jiz;
        this.A06 = jArr;
        this.A05 = iArr;
        this.A00 = i;
