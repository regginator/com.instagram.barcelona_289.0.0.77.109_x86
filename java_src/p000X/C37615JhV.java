...
public final class C37615JhV {
    ...
    public static void A01(int i, int i2) {
        ...
        throw new IndexOutOfBoundsException(C6GX.A00(str, A1Y));
    }
    ...
    public static void A03(int i, int i2, int i3) {
        ...
        if (i >= 0) {
            ...
            if (i <= i3) {
                if (i2 >= 0 && i2 <= i3) {
                    A00 = C6GX.A00("end index (%s) must not be less than start index (%s)", C25980wv.A1Y(Integer.valueOf(i2), i));
                } else {
