...
public class C38946KXd implements X509TrustManager {
    ...
    public C38946KXd(X509TrustManager x509TrustManager) {
        ...
        try {
            ...
            throw C25930wq.A0X("Failure initialising sandbox TrustManager");
        }
    }
}
