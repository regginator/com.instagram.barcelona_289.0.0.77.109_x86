...
public final class C69423b1 {
    ...
    public static final boolean A02(CallerContext callerContext, AbstractC18180if abstractC18180if, String str) {
        C25920wp.A1O(abstractC18180if, 0, callerContext);
        String str2 = callerContext.A02;
        C2T9.A00(abstractC18180if, "token_access", str, str2);
        if (!A03(str)) {
        ...
        return !C17570hg.A08(A00(callerContext, abstractC18180if, str));
    }
