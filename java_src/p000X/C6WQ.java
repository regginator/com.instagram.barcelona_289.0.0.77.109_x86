...
public final /* synthetic */ class C6WQ {
    ...
    static {
        ...
        A00 = iArr;
        try {
            C26000wx.A1L(JsonToken.BOOLEAN, iArr);
        } catch (NoSuchFieldError unused) {
        }
        try {
            C26000wx.A1M(JsonToken.NULL, iArr);
        } catch (NoSuchFieldError unused2) {
        }
        try {
            C91534uT.A1W(JsonToken.NUMBER, iArr);
        } catch (NoSuchFieldError unused3) {
        }
        try {
            C91564uW.A1P(JsonToken.STRING, iArr);
