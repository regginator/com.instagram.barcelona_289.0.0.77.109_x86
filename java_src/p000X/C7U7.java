...
public final class C7U7 implements InterfaceC149318cb {
    ...
    public final C7UR BgJ(long j) {
        ...
        if (num == num2) {
            ...
            return new C7UR(Bgb, A012) { // from class: X.54W
                @Override // p000X.C7UR
        ...
        return new C7UR(A022, BgY) { // from class: X.54W
            @Override // p000X.C7UR
            public final void A0D(InterfaceC13700Yl interfaceC13700Yl, float f, long j2) {
            }
    ...
    public C7U7(InterfaceC149108b2 interfaceC149108b2, Integer num, Integer num2) {
