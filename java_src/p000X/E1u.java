...
public final class E1u implements InterfaceC27767EdB {
    ...
    public final Object Bh1(DVZ dvz, InterfaceC148208Yc interfaceC148208Yc) {
        List list = this.A01;
        if (!C0OR.A0I(list, dvz.A0Z)) {
            C25626Daq A02 = C25626Daq.A02(this.A00);
            A02.A06 = AbstractC33547HPs.A00(list);
            return C25596DaJ.A00(A02, dvz);
        }
        return dvz;
    }

    public E1u(UserSession userSession, List list) {
