...
public final class E22 implements InterfaceC27767EdB {
    ...
    public final Object Bh1(DVZ dvz, InterfaceC148208Yc interfaceC148208Yc) {
        String str = this.A01;
        if (str == null || !str.equals(dvz.A0S)) {
            C25626Daq A02 = C25626Daq.A02(this.A00);
            A02.A0O = AbstractC33547HPs.A00(str);
            return C25596DaJ.A00(A02, dvz);
        }
        return dvz;
    }

    public E22(UserSession userSession, String str) {
