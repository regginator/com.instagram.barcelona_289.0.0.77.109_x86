...
public final class H8M implements InterfaceC34511Hor {
    ...
    public H8M(View view) {
        this.A00 = view;
        this.A02 = C28353Emo.A0N(view, R.id.row_user_imageview);
        this.A07 = C25940wr.A0T(view, R.id.row_user_imageview_reelring);
        this.A08 = C25940wr.A0T(view, R.id.row_user_stacked_avatar);
        this.A01 = C25920wp.A0K(view, R.id.row_text);
        this.A03 = C25940wr.A0T(view, R.id.row_follow_button);
        this.A05 = C25940wr.A0T(view, R.id.row_inline_survey);
        this.A04 = C25940wr.A0T(view, R.id.row_inline_survey_confirmation);
        this.A06 = C25940wr.A0T(view, R.id.row_quick_message_button);
    }
}
