...
public final class HAC implements InterfaceC34672HrY {
    ...
    public final int BN3(Context context) {
        return C28353Emo.A07(context).getDimensionPixelOffset(R.dimen.abc_select_dialog_padding_start_material);
    }
}
