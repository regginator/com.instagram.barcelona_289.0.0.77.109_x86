...
public final class HAH implements InterfaceC34672HrY {
    ...
    public final int BN3(Context context) {
        return C28353Emo.A07(context).getDimensionPixelOffset(R.dimen.account_permission_section_vertical_padding);
    }
}
