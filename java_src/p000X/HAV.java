...
public final class HAV implements InterfaceC34672HrY {
    ...
    public final int BN3(Context context) {
        return C28353Emo.A07(context).getDimensionPixelOffset(R.dimen.add_hashtags_notice_padding_horizontal);
    }
}
