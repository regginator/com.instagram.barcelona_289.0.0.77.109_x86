...
public final class HMP implements InterfaceC21952BoB, InterfaceC21414BfL {
    ...
    public HMP(CommentThreadFragment commentThreadFragment) {
    ...
    public final boolean BOb() {
        return CommentThreadFragment.A00(this.A00).BOd();
    }

    @Override // p000X.InterfaceC21952BoB
    public final boolean BVv() {
        CommentThreadFragment commentThreadFragment = this.A00;
        if (commentThreadFragment.A0T != null && CommentThreadFragment.A00(commentThreadFragment).BVy()) {
            return true;
        }
        return false;
    }
