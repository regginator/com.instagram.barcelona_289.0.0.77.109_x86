...
public final class JZ1 {
    ...
    public JZ1(Parcel parcel) {
        ...
        for (int i = 0; i < readInt; i++) {
            A0k.add(new JBB(parcel.readInt(), parcel.readLong()));
        }
    ...
    public JZ1(List list, int i, int i2, int i3, long j, long j2, long j3, boolean z, boolean z2, boolean z3, boolean z4) {
        this.A04 = j;
        this.A0A = z;
        this.A08 = z2;
        this.A09 = z3;
