...
public final class LJ8 extends MGk {
    public final /* synthetic */ C40912LdV A00;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LJ8(C40912LdV c40912LdV) {
        super(c40912LdV);
        this.A00 = c40912LdV;
    }
    ...
    public final String BHN(String str, int i) {
        ...
        if (str != null && str.length() != 0) {
            string = C25920wp.A0n(this.A00.A00, str, 2131836402);
        } else {
            string = this.A00.A00.getString(2131836401);
        }
        C0OR.A06(string);
        return string;
    }
