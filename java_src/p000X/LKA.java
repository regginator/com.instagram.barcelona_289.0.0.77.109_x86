...
public final class LKA extends DLQ {
    public final List A00;

    @Override // p000X.DLQ
    public final C18F A01(LMw lMw, CXPNoticeStateRepository cXPNoticeStateRepository) {
        C0OR.A0B(cXPNoticeStateRepository, 1);
        C18F A01 = LMV.A01(cXPNoticeStateRepository, "BOTTOMSHEET_MIGRATION_FEED_WAVE2");
        SharedPreferences A012 = C70173gG.A01(super.A00);
        return C40098Kyv.A0O(A012, A01, C25910wo.A00(1010), A012.getInt(C25910wo.A00(1009), 0));
    }
