...
public final class MEZ implements InterfaceC42375MdA {
    ...
    public final C40852LcT AKY(float f, float f2, float f3, float f4, float f5, float f6, float f7) {
        ...
        if (f >= BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER && f <= 1.0f) {
            ...
            float f9 = f8 / f5;
            float f10 = f8 / f7;
            return new C40852LcT(f9, f10, f4 * f9, f8, f6 * f10, f8);
        }
        f8 = C34904Hve.A01(f7, f5, f);
        float f92 = f8 / f5;
        float f102 = f8 / f7;
        return new C40852LcT(f92, f102, f4 * f92, f8, f6 * f102, f8);
    }

    @Override // p000X.InterfaceC42375MdA
    public final void A8y(RectF rectF, C40852LcT c40852LcT, float f) {
        float A01 = (C91544uU.A01(c40852LcT.A01, c40852LcT.A03) / 2.0f) * f;
        rectF.left += A01;
        rectF.right -= A01;
    }
    ...
    public final boolean CtA(C40852LcT c40852LcT) {
        return C25940wr.A1X((c40852LcT.A03 > c40852LcT.A01 ? 1 : (c40852LcT.A03 == c40852LcT.A01 ? 0 : -1)));
    }
}
