...
public final class MKJ implements Runnable {
    public final /* synthetic */ VideoPreviewView A00;

    public MKJ(VideoPreviewView videoPreviewView) {
    ...
    public final void run() {
        ...
        if (interfaceC42422MeN != null) {
            interfaceC42422MeN.CDf(videoPreviewView.A00.getCurrentPosition(), videoPreviewView.A00.getDuration());
